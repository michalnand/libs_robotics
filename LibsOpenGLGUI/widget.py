...
class Widget:
    def __init__(self, visualisation, variables, textures, params):
        ...
        from LibsOpenGLGUI.widget_frame            import WidgetFrame
        from LibsOpenGLGUI.widget_graph            import WidgetGraph
        from LibsOpenGLGUI.widget_bar_graph        import WidgetBarGraph
        from LibsOpenGLGUI.widget_text_frame       import WidgetTextFrame
        from LibsOpenGLGUI.widget_distance_sensor  import WidgetDistanceSensor
        from LibsOpenGLGUI.widget_model_frame      import WidgetModelFrame
        from LibsOpenGLGUI.widget_camera_frame     import WidgetCameraFrame
        from LibsOpenGLGUI.widget_image_frame      import WidgetImageFrame
